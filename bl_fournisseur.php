<?php 
    ...
    {
        $Num= 1;
        $sql3 = $connect->prepare("SELECT * FROM bl_fournisseur ORDER BY id DESC");
        $sql3->execute();
        $row = $sql3->rowCount();
        $units = $sql3->fetchAll();
 ...
 ?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <?php include ('includes/topbar.php'); ?>
        ...
        <h1 style="text-align:center;margin:60px">BL Fournisseur</h1>


        <div class="row">
              <div class="col-sm-1"></div>
              <div class="col-sm-2">
                  <button id="btnNewProduct" class="btn btn-primary" style="font-size: 12px">Ajouter un BL</button>
              </div>
