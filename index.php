  ...
  if (isset($_POST['login'])) 
  {
    ...
    if ($username && $password) {
      ...
      if($row == 1)
      {
        ...
        if($password == $data['password'] && $data['rank'] > 0 )
        {
                ...
                <div class="p-5">
                  ...
                  <form class="user">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Entrer votre username" name="username">
                    </div>
                    <div class="form-group">
